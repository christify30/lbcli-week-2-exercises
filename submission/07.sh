...
AddFunds=$(bitcoin-cli -regtest generatetoaddress 101 "$changeaddress")
...
raw_tx=$(bitcoin-cli -regtest -named createrawtransaction inputs='''[ { "txid": "'$utxo_txid_1'", "vout": '$utxo_vout_1' }]''' outputs='''{ "'$recipient'": 0.2, "'$changeaddress'": 0.03669108 }''')
